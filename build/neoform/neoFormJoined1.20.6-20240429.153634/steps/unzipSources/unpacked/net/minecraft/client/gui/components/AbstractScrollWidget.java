...
public abstract class AbstractScrollWidget extends AbstractWidget implements Renderable, GuiEventListener {
    ...
    @Override
    public boolean mouseScrolled(double p_239308_, double p_239309_, double p_239310_, double p_294677_) {
        if (!this.visible) {
            return false;
        } else {
            this.setScrollAmount(this.scrollAmount - p_294677_ * this.scrollRate());
            return true;
        }
    }
