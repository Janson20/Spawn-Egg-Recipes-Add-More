...
public class EnchantmentHelper {
    ...
    public static float calculateArmorBreach(@Nullable Entity p_338241_, float p_338545_) {
        if (p_338241_ instanceof LivingEntity livingentity) {
            int i = getEnchantmentLevel(Enchantments.BREACH, livingentity);
            if (i > 0) {
                return BreachEnchantment.calculateArmorBreach((float)i, p_338545_);
            }
        }
    ...
    public static void doPostItemStackHurtEffects(LivingEntity p_338188_, Entity p_338394_, ItemEnchantments p_338474_) {
        for (Entry<Holder<Enchantment>> entry : p_338474_.entrySet()) {
            entry.getKey().value().doPostItemStackHurt(p_338188_, p_338394_, entry.getIntValue());
        }
    }
    ...
    public static ItemStack enchantItem(FeatureFlagSet p_338479_, RandomSource p_220293_, ItemStack p_220294_, int p_220295_, boolean p_220296_) {
        List<EnchantmentInstance> list = selectEnchantment(p_338479_, p_220293_, p_220294_, p_220295_, p_220296_);
    ...
    public static List<EnchantmentInstance> selectEnchantment(
        FeatureFlagSet p_338533_, RandomSource p_220298_, ItemStack p_220299_, int p_220300_, boolean p_220301_
    ) {
        ...
        if (i <= 0) {
            ...
            List<EnchantmentInstance> list1 = getAvailableEnchantmentResults(p_338533_, p_220300_, p_220299_, p_220301_);
            if (!list1.isEmpty()) {
