...
public class DecoratedPotRenderer implements BlockEntityRenderer<DecoratedPotBlockEntity> {
    ...
    @Nullable
    private static Material getMaterial(Optional<Item> p_330793_) {
        if (p_330793_.isPresent()) {
            Material material = Sheets.getDecoratedPotMaterial(DecoratedPotPatterns.getResourceKey(p_330793_.get()));
            if (material != null) {
                return material;
            }
        }
