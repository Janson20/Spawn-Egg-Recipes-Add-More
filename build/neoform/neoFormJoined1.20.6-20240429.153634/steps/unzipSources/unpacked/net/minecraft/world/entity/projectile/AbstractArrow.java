...
public abstract class AbstractArrow extends Projectile {
    ...
    protected AbstractArrow(EntityType<? extends AbstractArrow> p_36711_, Level p_36715_, ItemStack p_308982_) {
        ...
        Unit unit = p_308982_.remove(DataComponents.INTANGIBLE_PROJECTILE);
        if (unit != null) {
    ...
    protected AbstractArrow(
        EntityType<? extends AbstractArrow> p_36721_, double p_309157_, double p_309022_, double p_308962_, Level p_36722_, ItemStack p_309145_
    ) {
    ...
    protected AbstractArrow(EntityType<? extends AbstractArrow> p_36717_, LivingEntity p_36718_, Level p_36719_, ItemStack p_309031_) {
        this(p_36717_, p_36718_.getX(), p_36718_.getEyeY() - 0.1F, p_36718_.getZ(), p_36719_, p_309031_);
