...
public class NoiseRouterData {
    ...
    public static Holder<? extends DensityFunction> bootstrap(BootstrapContext<DensityFunction> p_321740_) {
        HolderGetter<NormalNoise.NoiseParameters> holdergetter = p_321740_.lookup(Registries.NOISE);
        HolderGetter<DensityFunction> holdergetter1 = p_321740_.lookup(Registries.DENSITY_FUNCTION);
        p_321740_.register(ZERO, DensityFunctions.zero());
        int i = DimensionType.MIN_Y * 2;
        int j = DimensionType.MAX_Y * 2;
        p_321740_.register(Y, DensityFunctions.yClampedGradient(i, j, (double)i, (double)j));
        DensityFunction densityfunction = registerAndWrap(
            p_321740_, SHIFT_X, DensityFunctions.flatCache(DensityFunctions.cache2d(DensityFunctions.shiftA(holdergetter.getOrThrow(Noises.SHIFT))))
        );
        DensityFunction densityfunction1 = registerAndWrap(
            p_321740_, SHIFT_Z, DensityFunctions.flatCache(DensityFunctions.cache2d(DensityFunctions.shiftB(holdergetter.getOrThrow(Noises.SHIFT))))
        );
        p_321740_.register(BASE_3D_NOISE_OVERWORLD, BlendedNoise.createUnseeded(0.25, 0.125, 80.0, 160.0, 8.0));
        p_321740_.register(BASE_3D_NOISE_NETHER, BlendedNoise.createUnseeded(0.25, 0.375, 80.0, 60.0, 8.0));
        p_321740_.register(BASE_3D_NOISE_END, BlendedNoise.createUnseeded(0.25, 0.25, 80.0, 160.0, 4.0));
        Holder<DensityFunction> holder = p_321740_.register(
            CONTINENTS,
        ...
        Holder<DensityFunction> holder1 = p_321740_.register(
            EROSION,
        ...
        p_321740_.register(RIDGES_FOLDED, peaksAndValleys(densityfunction2));
        DensityFunction densityfunction3 = DensityFunctions.noise(holdergetter.getOrThrow(Noises.JAGGED), 1500.0, 0.0);
        registerTerrainNoises(p_321740_, holdergetter1, densityfunction3, holder, holder1, OFFSET, FACTOR, JAGGEDNESS, DEPTH, SLOPED_CHEESE, false);
        Holder<DensityFunction> holder2 = p_321740_.register(
            CONTINENTS_LARGE,
            DensityFunctions.flatCache(
        ...
        Holder<DensityFunction> holder3 = p_321740_.register(
            EROSION_LARGE,
        ...
        registerTerrainNoises(
            p_321740_, holdergetter1, densityfunction3, holder2, holder3, OFFSET_LARGE, FACTOR_LARGE, JAGGEDNESS_LARGE, DEPTH_LARGE, SLOPED_CHEESE_LARGE, false
        );
        registerTerrainNoises(
            p_321740_,
            holdergetter1,
        ...
        p_321740_.register(SLOPED_CHEESE_END, DensityFunctions.add(DensityFunctions.endIslands(0L), getFunction(holdergetter1, BASE_3D_NOISE_END)));
        p_321740_.register(SPAGHETTI_ROUGHNESS_FUNCTION, spaghettiRoughnessFunction(holdergetter));
        p_321740_.register(
        ...
        p_321740_.register(SPAGHETTI_2D, spaghetti2D(holdergetter1, holdergetter));
        p_321740_.register(ENTRANCES, entrances(holdergetter1, holdergetter));
        p_321740_.register(NOODLE, noodle(holdergetter1, holdergetter));
        return p_321740_.register(PILLARS, pillars(holdergetter));
    }

    private static void registerTerrainNoises(
        BootstrapContext<DensityFunction> p_321572_,
        ...
        DensityFunction densityfunction2 = registerAndWrap(
            p_321572_, p_224482_, DensityFunctions.add(DensityFunctions.yClampedGradient(-64, 320, 1.5, -1.5), densityfunction)
        );
        ...
        p_321572_.register(p_224483_, DensityFunctions.add(densityfunction5, getFunction(p_256393_, BASE_3D_NOISE_OVERWORLD)));
    }

    private static DensityFunction registerAndWrap(
        BootstrapContext<DensityFunction> p_321585_, ResourceKey<DensityFunction> p_255905_, DensityFunction p_255856_
    ) {
        return new DensityFunctions.HolderHolder(p_321585_.register(p_255905_, p_255856_));
    }
    ...
    private static DensityFunction spaghetti2D(HolderGetter<DensityFunction> p_256535_, HolderGetter<NormalNoise.NoiseParameters> p_255650_) {
        ...
        DensityFunction densityfunction2 = DensityFunctions.mappedNoise(
            p_255650_.getOrThrow(Noises.SPAGHETTI_2D_ELEVATION), 0.0, (double)Math.floorDiv(-64, 8), 8.0
        );
    ...
    protected static NoiseRouter overworld(
        ...
        DensityFunction densityfunction16 = yLimitedInterpolatable(
            densityfunction15, DensityFunctions.noise(p_256005_.getOrThrow(Noises.ORE_VEININESS), 1.5, 1.5), i, j, 0
        );
        float f = 4.0F;
        DensityFunction densityfunction17 = yLimitedInterpolatable(
                densityfunction15, DensityFunctions.noise(p_256005_.getOrThrow(Noises.ORE_VEIN_A), 4.0, 4.0), i, j, 0
            )
            .abs();
        DensityFunction densityfunction18 = yLimitedInterpolatable(
                densityfunction15, DensityFunctions.noise(p_256005_.getOrThrow(Noises.ORE_VEIN_B), 4.0, 4.0), i, j, 0
            )
            .abs();
